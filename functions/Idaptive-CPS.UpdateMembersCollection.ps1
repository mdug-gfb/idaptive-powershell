...
function UpdateMembersCollection {
    ...
    $updateResult = Idaptive-InvokeREST -Method "/collection/updatememberscollection" -Endpoint $endpoint -Token $bearerToken -ObjectContent $restArg -Verbose:$enableVerbose
